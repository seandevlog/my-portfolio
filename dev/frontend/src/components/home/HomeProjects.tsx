...
export default function HomeProjects() {
  return (
    <section className="relative flex h-fit w-full justify-center px-section-x-xs py-section-y-xs s:px-section-x-s s:py-section-y-s m:min-h-dvh m:px-section-x-m m:py-section-y-m l:px-section-x-l l:py-section-y-l xl:py-section-y-xl">
